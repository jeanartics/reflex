...
package body Back_End is
   ...
   procedure Call_Back_End (Mode : Back_End_Mode_Type) is
      ...
      procedure gigi (
         ...
         gigi_operating_mode           : Back_End_Mode_Type) is
      begin
	 null;
      end gigi;
   ...
   procedure Scan_Compiler_Arguments is
      ...
      begin
	    ...
	    if Argument (Integer (Arg))(Integer (J)) = ASCII.NUL then
               return J - 1;
            end if;
         end loop;
   ...
   begin
      ...
      Next_Arg := 1;
      while Next_Arg < Pos (Argument_Count) loop -- save_argc loop
	 Next_Arg := Next_Arg + 1;
      end loop;
      ...
      while Next_Arg <= Pos (Argument_Count) loop -- save_argc loop
         ...
         Look_At_Arg : declare
            ...
            Argv      : constant String := Argument (Integer (Next_Arg)); -- Argv_Ptr (1 .. Natural (Argv_Len));
