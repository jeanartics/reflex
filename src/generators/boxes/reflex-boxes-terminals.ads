...
package Reflex.Boxes.Terminals is
   ...
   subtype Contacts_Box is Box_Typ range Open_Contact_Box..Neg_Trans_Contact_Box;
   subtype Coils_Box    is Box_Typ range Coil_Box..Call_Coil_Box;
   subtype Objects_Box  is Box_Typ range Compare_Block_Box..Operate_Block_Box;
   ...
   function Get_Typ (This : access Terminal_Box_Record) return Box_Typ;
   procedure Set_Typ
