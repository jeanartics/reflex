...
package body Reflex.Rungs is
   ...
   begin
      Matrix := New_Matrix
	(Columns_Count => Max_Unity_Ladder_Horizontal,  --  X Coordinate
	 Lines_Count   => Max_Unity_Ladder_Vertical);   --  Y Coordinate
      Set_Matrix (This, Matrix);
      return This;
   end New_Rung;
   ...
   function Get_Matrix
     (This : access Rung_Record) return access Matrices.Matrix_Record is
   begin
      return This.Matrix;
   end Get_Matrix;
   ...
   procedure Set_Matrix
     (This : access Rung_Record;
      M    : access Matrices.Matrix_Record) is
   begin
      This.Matrix := M;
   end Set_Matrix;
