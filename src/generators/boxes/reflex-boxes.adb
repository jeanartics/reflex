...
package body Reflex.Boxes is
   ...
   --     -----------
   --     
   --     function Get_X (This : access Box_Record) return Natural is
   --     begin
   --        return This.X;
   --     end Get_X;
   --     
   ...
   --     -----------
   --     
   --     function Get_Y (This : access Box_Record) return Natural is
   --     begin
   --        return This.Y;
   --     end Get_Y;
   --     
   ...
   --    (This : access Box_Record) return access Builder_Interface'Class is
   --  begin
   --     return This.Builder;
   --  end Get_Builder;
   ...
   --    (This  : access Box_Record;
   --     Build : access Builder_Interface'Class) is
   --  begin
   --     This.Builder := Build;
   --  end Set_Builder;
...
--     ---------------
--     
--     procedure Place_Box (This : access Box_Record) is
--     begin
--        null;
--     end Place_Box;
