...
package Artics.Graph.Events.Remove_Cells_From_Parent_Events is
   
   use Artics.Graph.Events.Graph_Events;
   use Artics.Graph.Events.Graph_Listeners;
   use Artics.Graph.Events.Graph_Events_Sources;
   
   type Remove_Cells_From_Parent_Event_Record is
     new Graph_Event_Record with private;
   type Remove_Cells_From_Parent_Event_Ptr is
     access all Remove_Cells_From_Parent_Event_Record;
   type Remove_Cells_From_Parent_Event_Class_Ptr is
     access all Remove_Cells_From_Parent_Event_Record'Class;
   
   No_Remove_Cells_From_Parent_Event_Record  : 
     constant Remove_Cells_From_Parent_Event_Record;
   
   function New_Remove_Cells_From_Parent_Event
     return Remove_Cells_From_Parent_Event_Ptr;
   ...
   procedure Free_Remove_Cells_From_Parent_Event
     (This : in out Remove_Cells_From_Parent_Event_Ptr);
...
private
   ...
   type Remove_Cells_From_Parent_Event_Record is 
     new Graph_Event_Record with record
      Cells         : Cells_Lists.List;
   end record;
