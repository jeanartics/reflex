...
with Unity.Gen.Ch6; use Unity.Gen.Ch6;
with Unity.Gen.Ch7; use Unity.Gen.Ch7;
with Unity.Gen.Ch10; use Unity.Gen.Ch10;
with Reflex.Gen.Outputs; use Reflex.Gen.Outputs;
with Reflex.Infos; use Reflex.Infos;

package body Unity.Gen.Dispatch is
   ...
   begin
      if Node = Empty 
	or else Reflex_No_Generate (Node) 
	-- or else not Comes_From_Source (Node) then
      then
         return;
      end if;
...
--      This.Set_Output_Buffer (This.Get_Dummy_Output_Buffer);
	 ...
	 --  Types declarations 
	   ...
	   | N_Private_Type_Declaration        =>
	    ...
	    Unity.Gen.Ch3.Generate_Object_Declaration (This, Node);
	    ...
	    Generate_Access_Definition (This, Node);
         ...
         when N_Aggregate =>
	    Unity.Gen.Ch4.Generate_Aggregate (This, Node);
	    ...
	    Unity.Gen.Ch5.Generate_Case_Statement (This, Node);
	    ...
	    raise Program_Error; --  Generate_Component_Definition (This, Node);
         ...
         when N_Component_Declaration =>
            null; -- Unity.Decls.Generate_Component_Declaration (This, Node);
	    ...
	    Generate_Discriminant_Association (This, Node);
         ...
         when N_Elsif_Part =>
	    null; --  Unity.Gen.Ch5.Generate_Elsif_Part (This, Node);
         ...
         =>
            Unity.Gen.Ch3.Generate_Enumeration_Type_Definition (This, Node);
	    ...
	    Unity.Gen.Ch5.Generate_Exit_Statement (This, Node);
	    
         when N_Expanded_Name =>
	    Unity.Gen.Ch2.Generate_Expanded_Name (This, Node);
...
--              Freeze_Level := Freeze_Level - 1;
	    ...
	    Unity.Gen.Ch5.Generate_Handled_Sequence_Of_Statements (This, Node);

         when N_Identifier =>	
	    Unity.Gen.Ch2.Generate_Identifier (This, Node);

         when N_If_Statement =>
	    Unity.Gen.Ch5.Generate_If_Statement (This, Node);
	    ...
	    Unity.Gen.Ch4.Generate_Integer_Literal (This, Node);
...
--              null;
	    ...
	    Unity.Gen.Ch5.Generate_Loop_Statement (This, Node);
	    ...
	    Generate_Number_Declaration (This, Node);
         ...
         when N_Op_Abs =>
	    Unity.Gen.Ch4.Generate_Op_Abs (This, Node);
	    
         when N_Op_Add =>
	    Unity.Gen.Ch4.Generate_Op_Add (This, Node);

         when N_Op_And =>
	    Unity.Gen.Ch4.Generate_Op_And (This, Node);

         when N_Op_Concat =>
            raise Program_Error; -- should always be expanded

         when N_Op_Divide =>
	    Unity.Gen.Ch4.Generate_Op_Divide (This, Node);

         when N_Op_Eq =>
	    Unity.Gen.Ch4.Generate_Op_Eq (This, Node);
	    
         when N_Op_Expon =>
	    Unity.Gen.Ch4.Generate_Op_Expon (This, Node);

         when N_Op_Ge =>
	    Unity.Gen.Ch4.Generate_Op_Ge (This, Node);

         when N_Op_Gt =>
	    Unity.Gen.Ch4.Generate_Op_Gt (This, Node);

         when N_Op_Le =>
	    Unity.Gen.Ch4.Generate_Op_Le (This, Node);

         when N_Op_Lt =>
	    Unity.Gen.Ch4.Generate_Op_Lt (This, Node);

         when N_Op_Minus =>
	    Unity.Gen.Ch4.Generate_Op_Minus (This, Node);

         when N_Op_Mod =>
	    Unity.Gen.Ch4.Generate_Op_Mod (This, Node);

         when N_Op_Multiply =>
	    Unity.Gen.Ch4.Generate_Op_Multiply (This, Node);

         when N_Op_Ne =>
	    Unity.Gen.Ch4.Generate_Op_Ne (This, Node);

         when N_Op_Not =>
	    Unity.Gen.Ch4.Generate_Op_Not (This, Node);

         when N_Op_Or =>
	    Unity.Gen.Ch4.Generate_Op_Or (This, Node);

         when N_Op_Plus =>
	    Unity.Gen.Ch4.Generate_Op_Plus (This, Node);

         when N_Op_Rem =>
	    Unity.Gen.Ch4.Generate_Op_Rem (This, Node);
         ...
         when N_Op_Subtract =>
	    Unity.Gen.Ch4.Generate_Op_Subtract (This, Node);

         when N_Op_Xor =>
	    Unity.Gen.Ch4.Generate_Op_Xor (This, Node);
         ...
         when N_Or_Else =>
	    Unity.Gen.Ch4.Generate_Or_Else (This, Node);
	    ...
	    Unity.Gen.Ch2.Generate_Selected_Component (This, Node);
         ...
         when N_String_Literal =>
            Unity.Gen.Ch4.Generate_String_Literal (This, Node);

         when N_Subprogram_Body =>
	    Unity.Gen.Ch6.Generate_Subprogram_Body (This, Node);

         when N_Subprogram_Declaration =>
            Unity.Gen.Ch6.Generate_Subprogram_Declaration (This, Node);
         ...
         when N_Type_Conversion =>
            Unity.Gen.Ch4.Generate_Type_Conversion (This, Node);
