...
package body Rxvm.Gen is
   
   ----------------------
   -- New_Vm_Generator --
   ----------------------
   
   function New_Vm_Generator return Vm_Generator_Ptr is
      This : Vm_Generator_Ptr :=
        new Vm_Generator_Record'(No_Vm_Generator_Record);
   begin
      Create_Output_Buffer (This);
      This.Open_Scope (Empty);
      
      return This;
   end New_Vm_Generator;
