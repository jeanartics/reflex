...
package body Ch13 is
   ...
   begin
      Put_Line ("Aspect_Specifications_Present Begin " & Token'Img);
	 ...
	 Put_Line ("Not with");
      ...
      if Token /= Tok_Identifier then
	 Put_Line ("Token is nor identifier " & Token'Img);
         Result := False;
	 ...
	 Put_Line ("Aspect Token_Name " & Get_String (Token_Name));
      ...
      Restore_Scan_State (Scan_State);
      Put_Line ("Aspect_Specifications_Present Result " & Result'Img);
      return Result;
   ...
   begin
	 ...
	 Put_Line ("   Token_Name " & Get_String (Token_Name));
   ...
   begin
      Put_Line ("P_Aspect_Specifications Begin " & Token'Img);
      ...
      Put_Line ("P_Aspect_Specifications End");
