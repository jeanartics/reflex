...
package body Exp_Ch3 is
   ...
   begin
      ...
      return Is_RTU (S1, System) or else Is_RTU (S1, Rtsfind.Ada);
   end In_Runtime;
   ...
   -------------------------------------
   -- Replace_Array_Subtype_Component --
   -------------------------------------
   
   procedure Replace_Array_Subtype_Component is
      
      --  Comp_Def : Node_Id;
begin
     null;
      -- Create the the subtype constrainted definition for the component
      ...
      --  	   (Discrete_Subtype_Definitions => New_Copy_List (Indexes),
   ...
   end Replace_Array_Subtype_Component;
