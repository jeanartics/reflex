...
begin
   ...
   begin
	 ...
	 N := String_Find (Exe & "system.rxs");
      ...
      if Targparm.Configurable_Run_Time_On_Target then
	 ...
	 Write_Str ("-gnatc");
      ...
      Reflex.Gen.Outputs.Comment_Type := Reflex.Gen.Outputs.Ada_Comment_Type;
      Glips.Generator.Do_Generation;
