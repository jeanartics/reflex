...
with Reflex.Gen.Outputs;
with Unity_Standard_Lib;
...
begin
   ...
   begin
      ...
      then
         ...
         --Write_Str (" Copyright 2012-2019 Artics, Inc.");
	 declare
	    version : constant string := "0.2";
	    target  : constant string := "unity";
	 begin
	    Put_Line("reflex compiler v" & version & " - target " & target);
	    Put_Line("**** all this is to ignore....");
	 end;
   --  Write_Eol;
      end if;
      ...
      --  Post semantic checks
      
      Unity_Standard_Lib.Create_Unity_Standard;
      ...
      Reflex.Gen.Outputs.Comment_Type := Reflex.Gen.Outputs.Iec_Comment_Type;
      --  Reflex.Gen.Outputs.Ada_Comment_Type := False;
      
      Unity.Generator.Do_Generation;
