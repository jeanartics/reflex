...
begin
   ...
   begin
      ...
      Reflex_Options.Plc_Target := Reflex_Options.Tia_Target;
      Write_Line ("reflex compiler v0.9 - target Siemens Tia");
      ...
      --  Restrict.Restrictions.Set   (No_Dispatching_Calls) := True;
      --  Restrict.Restrictions.Set   (No_Streams)           := True;
      --  Restrict.Restrictions.Set   (No_Finalization)      := True;
      --  JMA End
      ...
      if False and then Back_End_Mode = Declarations_Only
        and then
	 ...
	 Siemens.Generator.Do_Generation;
