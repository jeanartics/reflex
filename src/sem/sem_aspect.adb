...
package body Sem_Ch13 is
   ...
   -------------------------------------------
   -- Analyze_Aspect_Specifications_On_Body --
   -------------------------------------------

   procedure Analyze_Aspect_Specifications_On_Body (N : Node_Id) is
      ...
      begin
         ...
         while Present (Asp) loop
            ...
            if Aspect_On_Body_OK (Get_Aspect_Id (Asp_Nam)) then
               null;
   ...
   begin
      ...
      if Spec_Id /= Body_Id and then not Aspects_On_Body_OK (N) then
         Diagnose_Misplaced_Aspects (Spec_Id);
      else
         Analyze_Aspect_Specifications (N, Body_Id);
      end if;
   end Analyze_Aspect_Specifications_On_Body;
