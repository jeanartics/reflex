...
--  tree, transforming it in various ways and adding semantic information.
   ...
   subtype Reflex_Transform_Record is System.Address;

   function Get_Rx_Infos
     (Node : Node_Id) return System.Address;
   procedure Set_Rx_Infos
     (Node     : Node_Id;
      Rx_Infos : System.Address);

   No_Reflex_Transform_Record : constant Reflex_Transform_Record
     := System.Null_Address;

   package Trans_Nodes is new Table.Table (
      Table_Component_Type => Reflex_Transform_Record,
      Table_Index_Type     => Node_Id'Base,
      Table_Low_Bound      => First_Node_Id,
      Table_Initial        => Alloc.Orig_Nodes_Initial,
      Table_Increment      => Alloc.Orig_Nodes_Increment,
      Table_Name           => "Trans_Nodes");
