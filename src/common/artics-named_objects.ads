...
package Artics.Named_Objects is
   
   -- type Named_Object_Record 
   type Named_Object_Record is new Object_Record with private;
   type Named_Object_Ptr is access all Named_Object_Record;
   type Named_Object_Class_Ptr is access all Named_Object_Record'Class;
   ...
   No_Named_Object_Record : constant Named_Object_Record;
...
private
   ...
   No_Named_Object_Record : constant Named_Object_Record :=
     (No_Object_Record with Name => No_Name);
