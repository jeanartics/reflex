...
package Artics.Dynamic_Arrays is
   ...
   function New_Dynamic_Array_From_Copy
     (Array_Ptr : Dynamic_Array_Ptr) return Dynamic_Array_Ptr;
   -- Create a new array and initialize it with Array_Ptr.
   ...
   procedure Resize_Init
     (Array_Ptr : in out Dynamic_Array_Ptr;
      Count     : Element_Index);
   -- Resize Array_Ptr to count elements and initialized it with No_element.
   ...
   function Clone_Array (Src : Dynamic_Array_Ptr) return Dynamic_Array_Ptr;
