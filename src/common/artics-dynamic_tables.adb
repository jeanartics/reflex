...
package body Artics.Dynamic_Tables is
   ...
   is
      ...
      Allocated_Tablex : Allocated_Table_T;
      pragma Import (Ada, Allocated_Tablex);
      pragma Suppress (Range_Check, On => Allocated_Tablex);
      for Allocated_Tablex'Address use Allocated_Table_Address;
   ...
   begin
      ...
      if Need_Realloc
        and then Allocated_Tablex'Address <= Item'Address
        and then Item'Address <
                   Allocated_Tablex (Table_Index_Type (T.P.Max + 1))'Address
      then
