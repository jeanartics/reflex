...
private
   ...
   package Uints is new Table.Table (
     ...
     Table_Initial        => Uints_Initial,
     Table_Increment      => Uints_Increment,
     Table_Name           => "Uints");
   ...
   package Udigits is new Table.Table (
     ...
     Table_Low_Bound      => 0,
     Table_Initial        => Udigits_Initial,
     Table_Increment      => Udigits_Increment,
     Table_Name           => "Udigits");
