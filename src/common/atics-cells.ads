...
package Artics.Cells is
   ...
   function Get_Next (C : Cell_Id) return Cell_Id;
   pragma Inline (Get_Next);
   -- Return the next Cell.

   function Get_Previous (C : Cell_Id) return Cell_Id;
