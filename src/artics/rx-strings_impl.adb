...
package body Rx.Strings_Impl is
   ...
   package body Strings is
      ...
      Unshareable : constant Rx.Atomic.Atomic_Counter :=
         Rx.Atomic.Atomic_Counter'Last;
      ...
      Extra_Header_Size : constant System.Memory.size_t :=
         (if Copy_On_Write
          then System.Memory.size_t (Rx.Atomic.Atomic_Counter'Size / 8)
          else 0);
      ...
      Make_Writable : constant not null
         access procedure (Self : in out XString) :=
            (if Rx.Refcount.Application_Uses_Tasks
