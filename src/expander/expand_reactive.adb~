...
--     end Need_To_Prefixed;
   ...
   begin
      ...
      --  Make the states enumeration type definition. First create a literal
      --  for each state
	...
	(Sloc       => Sloc (T),
	 ...
	 Append (Lit, Lits_List);
	 Next (State);
      end loop;
      
      --  Make array of states type definition with index of the enumeartion 
      --  type just defined
	...
	(Make_Range_Constraint 
	   (Sloc             => Sloc (T),
	    Range_Expression =>
		 ...
		 (Sloc       => Sloc (T),
		  Low_Bound  => 
		    New_Reference_To (First (Lits_List), Sloc (T)),
		  High_Bound => 
		    New_Occurrence_Of (Last (Lits_List), Sloc (T)))),
