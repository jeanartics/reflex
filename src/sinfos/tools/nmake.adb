...
package body Nmake is
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Aspect_Specification, Sloc);
   begin
      Set_Identifier (N, Identifier);
      Set_Expression (N, Expression);
      Set_Class_Present (N, Class_Present);
      Set_Split_PPC (N, Split_PPC);
      return N;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Reactive_State, Sloc);
   begin
      Set_Defining_Identifier (N, Defining_Identifier);
      Set_Corresponding_Node (N, Corresponding_Node);
      return N;
   end Make_Reactive_State;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Reactive_Wait_Statement, Sloc);
   begin
      Set_State_Identifier (N, State_Identifier);
      Set_Condition (N, Condition);
      return N;
   end Make_Reactive_Wait_Statement;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Reactive_Pause_Statement, Sloc);
   begin
      Set_State_Identifier (N, State_Identifier);
      return N;
   end Make_Reactive_Pause_Statement;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Reactive_Fork_Statement, Sloc);
   begin
      Set_Condition (N, Condition);
      Set_Alternatives (N, Alternatives);
      return N;
   end Make_Reactive_Fork_Statement;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Reactive_Fork_Alternative, Sloc);
   begin
      Set_Statements (N, Statements);
      return N;
   end Make_Reactive_Fork_Alternative;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Reactive_Select_Statement, Sloc);
   begin
      Set_State_Identifier (N, State_Identifier);
      Set_Alternatives (N, Alternatives);
      return N;
   end Make_Reactive_Select_Statement;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Reactive_Select_Alternative, Sloc);
   begin
      Set_Condition (N, Condition);
      Set_Statements (N, Statements);
      return N;
   end Make_Reactive_Select_Alternative;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Reactive_Abort_Statement, Sloc);
   begin
      Set_Condition (N, Condition);
      Set_Statements (N, Statements);
      Set_Abort_Handler (N, Abort_Handler);
      return N;
   end Make_Reactive_Abort_Statement;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Reactive_Abort_Handler, Sloc);
   begin
      Set_Statements (N, Statements);
      return N;
   end Make_Reactive_Abort_Handler;
